        ...
        <div className="space-y-4 text-left bg-navy/50 p-4 rounded-md">
          <div>
            ...
            <p className="text-slate">
              ...
              , <span className="text-red-400">{winnerStats.misses} erros</span>{" "}
              — {winnerStats.accuracy}% precisão
            </p>
          </div>
          <div>
            ...
            <p className="text-slate">
              ...
              <span className="text-red-400">{loserStats.misses} erros</span> —{" "}
              {loserStats.accuracy}% precisão
            </p>
          </div>
        </div>
